...
if [ -f "client_credentials" ]; then
  . /home/runner/work/Automate-Product-Migration-Testing/Automate-Product-Migration-Testing/00-Data-Population/00-4service-provider-creation/client_credentials
