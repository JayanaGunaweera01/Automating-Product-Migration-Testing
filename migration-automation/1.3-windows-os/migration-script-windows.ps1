...
cd D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD
...
chmod +x /d/a/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-automation/IS_HOME_OLD/wso2is-5.11.0/repository/conf/deployment.toml
...
#for file in $(find  D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\repository\conf -type f -name 'deployment.toml');
#do
#cat  D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\deploymentwindowsmysql.toml > $file;

#done

$files = Get-ChildItem -Path "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\repository\conf" -Recurse -Filter "deployment.toml"

foreach ($file in $files) {
  $content = Get-Content "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\deploymentwindowsmysql.toml"
...
#chmod +x ~/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/utils/3.1-db-scripts/IS-5.11/mysql.sql
#docker exec -i amazing_feynman sh -c 'exec mysql -uroot -proot -D testdb' < ~/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/utils/3.1-db-scripts/IS-5.11/mysql.sql
#docker exec -i amazing_feynman sh -c 'exec mysql -uroot -proot -D testdb' < ~/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/utils/3.1-db-scripts/IS-5.11/identity/mysql.sql
#docker exec -i amazing_feynman sh -c 'exec mysql -uroot -proot -D testdb' < ~/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/utils/3.1-db-scripts/IS-5.11/identity/uma/mysql.sql
#docker exec -i amazing_feynman sh -c 'exec mysql -uroot -proot -D testdb' < ~/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/utils/3.1-db-scripts/IS-5.11/consent/mysql.sql
#docker exec -i amazing_feynman sh -c 'exec mysql -uroot -proot -D testdb' < ~/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/utils/3.1-db-scripts/IS-5.11/metrics/mysql.sql
...
#cp -r D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\utils\mysql-connector-java-8.0.29.jar D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\repository\components\lib\
Copy-Item -Path "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\utils\mysql-connector-java-8.0.29.jar" -Destination "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\repository\components\lib\"

Write-Host "`e[0;32m`e[1mPlaced JDBC driver successfully`e[0m"
# Wait for the JDBC driver to be copied to the lib folder
while(!(Test-Path "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\repository\components\lib\mysql-connector-java-8.0.29.jar")) {
...
Set-Content -Path "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\repository\conf\tomcat\catalina-server.xml" -Value ('<?xml version="1.0" encoding="UTF-8"?>
...
Set-Content -Path $startBatPath -Value "set RUNTIME_PATH=$runPath`nD:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\bin\wso2server.bat -Dcarbon.bootstrap.timeout=300" | Out-Null
...
#cd /home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-automation/IS_HOME_OLD/wso2is-5.11.0/bin
...
# cd "$BIN_ISOLD"
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\bin"
Write-Host "`e[0;32m`e[1mEntered bin successfully`e[0m"

#D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0\bin\wso2server.bat stop
#$IS_HOME_OLD = "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_OLD\wso2is-5.11.0"
...
# Navigate to folder 
# cd IS_HOME_NEW
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW"
pwd
...
$newISHOME = "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\$extractedDir\repository\components"
...
#while [ ! -f "/home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-automation/wso2is-migration-1.0.225" ]
#do
...
cp -r "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\utils\wso2is-migration-1.0.225" "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0\repository\components" 
sleep 10
...
cp -r "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\utils\wso2is-migration-1.0.225\migration-resources"  "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0"
sleep 10
...
$files = Get-ChildItem -Path "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0\repository\conf" -Recurse -Filter "deployment.toml"
...
#cd "$BIN_ISNEW"
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0\bin"
...
echo set RUNTIME_PATH=D:\wso2\runmigration > D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0\bin\wso2server.bat
...
# wso2server.sh stop
#D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0\bin\wso2server.bat stop
#sleep 120
...
echo set RUNTIME_PATH=D:\wso2\runmigrated > D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\migration-automation\IS_HOME_NEW\wso2is-6.0.0\bin\wso2server.bat
