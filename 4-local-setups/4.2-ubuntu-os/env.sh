...
export DATA_POPULATION=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation

# Absolute path to database validation script
export GENERATE_TOKEN=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation/00-4service-provider-creation


# Absolute path to home folder
export AUTOMATION_HOME=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups

# Absolute path to home folder-1-migration-automation
export AUTOMATION_HOME_01_Migration_Automation=/home/wso2/Downloads/Automating-Product-Migration-Testing/1-migration-automation

# Absolute path to the deployment file to replace
export DEPLOYMENT=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/repository/conf/deployment.toml

# Absolute path to the oldIS deployment file 
export DEPLOYMENT_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/repository/conf
...
export BIN_ISOLD=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/bin

# Absolute path to IS New bin folder
export BIN_ISNEW=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/bin
...
export JDBC=/home/wso2/Downloads/Automating-Product-Migration-Testing/3-utils

# Absolute path for the <IS_HOME_OLD>/repository/components/lib folder
export LIB=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/repository/components/lib

# Absolute path for the mysql Jar file in 3-utils folder
export MYSQL_JAR=/home/wso2/Downloads/Automating-Product-Migration-Testing/3-utils/mysql-connector-java-8.0.29.jar

# Absolute path for the <IS_HOME_NEW>/repository/components/lib folder
export LIB_NEW=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/repository/components/

# Absolute path for the <IS_HOME_OLD>/Tenants folder
export TENANT_OLD_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/repository

# Absolute path for the <IS_HOME_NEW>/Tenants folder
export TENANT_NEW_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/repository/components/

# Absolute path for the <IS_HOME_OLD>/Resources folder
export RESOURCES_OLD_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/repository/resources

# Absolute path for the <IS_HOME_NEW>/Resources folder
export RESOURCES_NEW_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/repository/resources

# Absolute path for the <IS_HOME_OLD>/Userstores folder
export USERSTORE_OLD_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_OLD/wso2is-5.11.0/repository/deployment/server/userstores

# Absolute path for the <IS_HOME_NEW>/Userstores folder
export USERSTORE_NEW_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/repository/deployment/server/
...
export 3-utils_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/3-utils

# Absolute path to IS_MIGRATION_TOOL_HOME/dropins home folder
export DROPINS_PATH_HOME=/home/wso2/Downloads/Automating-Product-Migration-Testing/3-utils/wso2is-migration-1.0.225

# Absolute path to IS_MIGRATION_TOOL_HOME/dropins folder
export DROPINS_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/3-utils/wso2is-migration-1.0.225/dropins

# Absolute path to IS_HOME_NEW/repository/components
export COMPONENTS_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/repository/components

# Absolute path to migration resources folder
export MIGRATION_RESOURCES=/home/wso2/Downloads/Automating-Product-Migration-Testing/3-utils/wso2is-migration-1.0.225/migration-resources

# Absolute path to latest wso2IS root folder
export IS_NEW_ROOT=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0

# Absolute path to migration resources folder in latest IS
export MIGRATION_RESOURCES_NEW_IS=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/migration-resources

# Absolute path to migration config.yaml file in new IS
export MIGRATION_CONFIG_YAML=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups/IS_HOME_NEW/wso2is-6.0.0/migration-resources/migration-config.yaml


# Env configs related to 2-data-population-and-validation folder
##################################################
...
export USER_CREATION=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation/00-1user-creation

# Absolute path to tenants creation shell files
export TENANT_CREATION=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation/00-2tenant-creation

# Absolute path to userstore creation shell files
export USERSTORE_CREATION=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation/00-3userstore-creation
...
export GROUP_CREATION=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation/00-5group-creation
...
export SP_CREATION=/home/wso2/Downloads/Automating-Product-Migration-Testing/2-data-population-and-validation/00-4service-provider-creation
...
#Database bckup
export BACKUP_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/1-migration-automation/backup_db.sql

export LOCAL_SETUP=/home/wso2/Downloads/Automating-Product-Migration-Testing/4-local-setups
