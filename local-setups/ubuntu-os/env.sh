...
# Absolute path to home folder-migration-automation
export AUTOMATION_HOME_01_Migration_Automation=/home/wso2/Downloads/Automating-Product-Migration-Testing/migration-automation
...
# Absolute path to the deployment file in migration-automation folder
exportDEPLOYMENT_AUTOMATION_MYSQL=/home/wso2/Downloads/Automating-Product-Migration-Testing/migration-automation/deployment.toml
...
#Database bckup
export BACKUP_PATH=/home/wso2/Downloads/Automating-Product-Migration-Testing/migration-automation/backup_db.sql
