...
chmod +x /home/wso2/Downloads/Automating-Product-Migration-Testing/local-setups/migration-automation-script-linux.sh
chmod +x /home/wso2/Downloads/Automating-Product-Migration-Testing/local-setups/migration-automation-script-macos.sh
chmod +x /home/wso2/Downloads/Automating-Product-Migration-Testing/local-setups/migration-automation-script-windows.ps1
...
if [ "$db" = "mysql" ] && [ "$os" = "ubuntu" ]; then
    ...
    sh /home/wso2/Downloads/Automating-Product-Migration-Testing/local-setups/migration-automation-script-linux.sh
elif [ "$db" = "mssql" ] && [ "$os" = "macos" ]; then
    echo -e "${BOLD}${GREEN}Executing migration-automation-script-macos.sh for MSSQL on macOS${NC}"
    sh /home/wso2/Downloads/Automating-Product-Migration-Testing/local-setups/migration-automation-script-macos.sh
    ...
    sh /home/wso2/Downloads/Automating-Product-Migration-Testing/local-setups/migration-automation-script-windows.ps1
else
