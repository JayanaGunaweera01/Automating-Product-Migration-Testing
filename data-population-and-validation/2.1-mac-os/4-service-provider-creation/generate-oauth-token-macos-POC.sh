...
if [ -f "client_credentials" ]; then
  . /Users/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/02-POC/macos/data-population-and-validation/00-4service-provider-creation/client_credentials
