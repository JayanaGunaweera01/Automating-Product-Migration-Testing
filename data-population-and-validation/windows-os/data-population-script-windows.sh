...
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\02-POC\macos\data-population-and-validation\00-1user-creation"
sh create-user.sh
...
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\02-POC\macos\data-population-and-validation\00-2tenant-creation"
...
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\02-POC\macos\data-population-and-validation\00-3userstore-creation"
...
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\02-POC\macos\data-population-and-validation\00-5group-creation"
...
cd "D:\a\Automating-Product-Migration-Testing\Automating-Product-Migration-Testing\02-POC\macos\data-population-and-validation\00-4service-provider-creation"
